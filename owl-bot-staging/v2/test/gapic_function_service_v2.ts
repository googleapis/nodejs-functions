...
describe('v2.FunctionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = functionserviceModule.v2.FunctionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = functionserviceModule.v2.FunctionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = functionserviceModule.v2.FunctionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new functionserviceModule.v2.FunctionServiceClient();
        assert(client);
    });
    ...
    describe('getFunction', () => {
        it('invokes getFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2.GetFunctionRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2.Function());
        ...
        it('invokes getFunction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFunction(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2.IFunction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateUploadUrl', () => {
        it('invokes generateUploadUrl without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2.GenerateUploadUrlResponse());
        ...
        it('invokes generateUploadUrl without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateUploadUrl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2.IGenerateUploadUrlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateDownloadUrl', () => {
        it('invokes generateDownloadUrl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2.GenerateDownloadUrlRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2.GenerateDownloadUrlResponse());
        ...
        it('invokes generateDownloadUrl without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateDownloadUrl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2.IGenerateDownloadUrlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listRuntimes', () => {
        it('invokes listRuntimes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2.ListRuntimesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2.ListRuntimesResponse());
        ...
        it('invokes listRuntimes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listRuntimes(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2.IListRuntimesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createFunction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFunction(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.functions.v2.IFunction, protos.google.cloud.functions.v2.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.functions.v2.IFunction, protos.google.cloud.functions.v2.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createFunction as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('updateFunction', () => {
        it('invokes updateFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2.UpdateFunctionRequest());
            request.function = {};
    ...
    describe('deleteFunction', () => {
        it('invokes deleteFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2.DeleteFunctionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteFunction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteFunction(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.functions.v2.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.functions.v2.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteFunction as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listFunctions', () => {
        it('invokes listFunctions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2.ListFunctionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.functions.v2.Function()),
              generateSampleMessage(new protos.google.cloud.functions.v2.Function()),
              generateSampleMessage(new protos.google.cloud.functions.v2.Function()),
            ];
        ...
        it('invokes listFunctionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.functions.v2.Function[] = [];
                stream.on('data', (response: protos.google.cloud.functions.v2.Function) => {
        ...
        it('uses async iteration with listFunctions without error', async () => {
            ...
            const responses: protos.google.cloud.functions.v2.IFunction[] = [];
