...
describe('v2beta.FunctionServiceClient', () => {
    ...
    describe('getFunction', () => {
        it('invokes getFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2beta.GetFunctionRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2beta.Function());
    ...
    describe('generateUploadUrl', () => {
        it('invokes generateUploadUrl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2beta.GenerateUploadUrlRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2beta.GenerateUploadUrlResponse());
    ...
    describe('generateDownloadUrl', () => {
        it('invokes generateDownloadUrl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2beta.GenerateDownloadUrlRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2beta.GenerateDownloadUrlResponse());
    ...
    describe('listRuntimes', () => {
        it('invokes listRuntimes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2beta.ListRuntimesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.functions.v2beta.ListRuntimesResponse());
    ...
    describe('createFunction', () => {
        it('invokes createFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2beta.CreateFunctionRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteFunction', () => {
        it('invokes deleteFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.functions.v2beta.DeleteFunctionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
