...
describe('v2.FunctionServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        functionserviceModule.v2.FunctionServiceClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        functionserviceModule.v2.FunctionServiceClient.apiEndpoint;
      assert(apiEndpoint);
    });
    ...
    it('invokes getFunction without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFunction(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2.IFunction | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateUploadUrl without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateUploadUrl(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2.IGenerateUploadUrlResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateDownloadUrl without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateDownloadUrl(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2.IGenerateDownloadUrlResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRuntimes without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRuntimes(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2.IListRuntimesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listFunctions', () => {
    ...
    it('invokes listFunctionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.functions.v2.Function) => {
