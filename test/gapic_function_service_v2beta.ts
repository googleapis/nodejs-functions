...
describe('v2beta.FunctionServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        functionserviceModule.v2beta.FunctionServiceClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        functionserviceModule.v2beta.FunctionServiceClient.apiEndpoint;
      assert(apiEndpoint);
    });
    ...
    it('invokes getFunction without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFunction(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2beta.IFunction | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateUploadUrl without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateUploadUrl(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2beta.IGenerateUploadUrlResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateDownloadUrl without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateDownloadUrl(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2beta.IGenerateDownloadUrlResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRuntimes without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRuntimes(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.functions.v2beta.IListRuntimesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
        ...
        client.createFunction(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.functions.v2beta.IOperationMetadata
            > | null
          ) => {
            if (err) {
              reject(err);
  ...
  describe('listFunctions', () => {
    ...
    it('invokes listFunctionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.functions.v2beta.Function) => {
